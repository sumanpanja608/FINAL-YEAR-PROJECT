...
models = {
    ...
    'CatBoost': CatBoostRegressor(iterations=100, learning_rate=0.1, depth=6, silent=True, random_seed=42),
...
plt.savefig('tree_models_actual_vs_predicted_subplots.tiff', format='tiff', dpi=1200)
plt.show()

# Print metrics
print("\nTree-Based Models Performance Metrics:\n")
